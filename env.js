 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.expo-owner.staging
 */

// TODO: Replace these values with your own

const PACKAGE = 'com.api.solaris'; // android package name
const NAME = 'Solaris'; // app name
const EXPO_ACCOUNT_OWNER = 'expo-owner'; // expo account owner
const EAS_PROJECT_ID = '23061189-1b7a-44bb-ae5d-4292d049752a'; // eas project id
